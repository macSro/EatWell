...
class RecipeBloc extends Bloc<RecipeEvent, RecipeState> {
  ...
  Stream<RecipeState> mapEventToState(RecipeEvent event) async* {
    ...
    else if (event is FetchRecipeInfo) yield* _fetchRecipeInfo(event.recipeId);
  }

  Stream<RecipeState> _fetchAllRecipes() async* {
    yield RecipeLoading();
    ...
    yield FetchedAllRecipes(recipes: recipes);
  }
  ...
  Stream<RecipeState> _fetchRecipeInfo(int recipeId) async* {
    ...
    yield FetchedRecipeInfo(recipe: recipe);
  }
}
